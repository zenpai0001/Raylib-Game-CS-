...
namespace Ldtk
{
    ...
    [JsonSerializable(typeof(LdtkJson))]
    ...
    public enum ImageExportMode { Horizontal, None };

    public enum TileMode { Single, Stamp };

    public partial class LdtkJson
    {
        public static LdtkJson FromJson(string json) => JsonSerializer.Deserialize<LdtkJson>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this LdtkJson self) => JsonSerializer.Serialize(self, Converter.Settings);
    }
    ...
    internal class ImageExportModeConverter : JsonConverter<ImageExportMode>
    {
        ...
        public override ImageExportMode Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            {
                case "Horizontal":
                    return ImageExportMode.Horizontal;
                case "None":
        ...
        public override void Write(Utf8JsonWriter writer, ImageExportMode value, JsonSerializerOptions options)
        {
            switch (value)
            {
                case ImageExportMode.Horizontal:
